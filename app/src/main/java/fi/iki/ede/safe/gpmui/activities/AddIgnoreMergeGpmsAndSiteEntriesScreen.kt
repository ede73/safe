...
import fi.iki.ede.gpmui.composables.AddIgnoreMergeGpmsAndSiteEntriesControls
import fi.iki.ede.gpmui.composables.AddIgnoreMergeGpmsAndSiteEntriesList
        ...
        setContent {
            SafeTheme {
                Surface(
                    ...
                    Column {
                        AddIgnoreMergeGpmsAndSiteEntriesControls(DataModelForGPM, viewModel)
                        AddIgnoreMergeGpmsAndSiteEntriesList(
                            DataModelForGPM,
                            viewModel,
                        )
                    }
