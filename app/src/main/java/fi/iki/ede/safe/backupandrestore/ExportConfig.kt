...
abstract class ExportConfig(currentCodedVersion: ExportVersion) {
    ...
    companion object {
        ...
        enum class Elements(val value: String) {
            ...
            SITE_ENTRY_EXTENSIONS("extensions"),
            SITE_ENTRY_EXTENSIONS_EXTENSION("extension"),
            SITE_ENTRY_EXTENSIONS_EXTENSION_VALUE("value"),
            IMPORTS("imports"),
            IMPORTS_GPM("gpm"),
        ...
        enum class Attributes(val value: String) {
            ...
            SITE_ENTRY_EXTENSION_NAME("extensionname"),
            IV("iv"),
