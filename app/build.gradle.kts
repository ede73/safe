...
android {
    ...
    defaultConfig {
        ...
        val (versionMajor, versionMinor, versionPatch, versionBuild) = listOf(3, 0, 47, 0)
        versionCode =
...
dependencies {
    ...
    implementation(libs.firebase.bom) // firebase crashalytics
    implementation(libs.firebase.analytics) // firebase crashalytics
